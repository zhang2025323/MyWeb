    ...
    return {
      weblist1: [
        ...
        },
        {
          ...
          desc: "提供各类考试题库资源,是软件,提供部分的软件下载试题",
      ...
      weblist2: [
        ...
        },
        {
          id: 507,
          uname: "资源分享",
          link: "https://link3.cc/ym09",
          desc: "提供各类优质资源免费分享",
          icon2: new URL('@/assets/icons/link3.ico', import.meta.url).href,
        },
        {
          id: 508,
          uname: "在线转换",
